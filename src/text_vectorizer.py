...
class TextVectorizer(BaseEstimator, TransformerMixin):
    def __init__(self,
                 fitted_tokenizer: kp.text.Tokenizer = None,
                 common_terms_list: List[str] = None,
                 ngrams_detector_list: List[gensim.models.phrases.Phraser] = None,
        ...
        self.debug_messages = enable_plots

        self.df_ngrams: Optional[pd.DataFrame] = None
        self.nlp: Optional[gensim.models.word2vec.Word2Vec] = None
        self.ngrams_detector_list: Optional[List[gensim.models.phrases.Phraser]] = ngrams_detector_list
        self.fitted_tokenizer: Optional[kp.text.Tokenizer] = fitted_tokenizer
